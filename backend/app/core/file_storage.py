...
✅ SECURITY FIX: Supports Azure Blob Storage to prevent data loss in serverless environments.
"""
...
def get_upload_dir() -> str:
    ...
    Use cloud storage (Azure Blob) in production.
    """
    ...
    if settings.STORAGE_TYPE.lower() == "local":
        ...
        if settings.is_production() and upload_dir.startswith("/tmp"):
            logger.warning(
                ...
                "Files will be lost. Set STORAGE_TYPE=azure and configure Azure Blob Storage."
            )
