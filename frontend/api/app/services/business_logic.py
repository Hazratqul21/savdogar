...
class BusinessLogicService:
    ...
    def can_add_to_cart(
        ...
        elif business_type == BusinessType.TOBACCO:
    ...
    def requires_variant_selection(
        ...
        """
        if business_type == BusinessType.FASHION:
            # Fashion: Always show size/color matrix
            if product.type.value == "variable":
                return True
        
        if business_type == BusinessType.JEWELRY:
    ...
    def process_sale_metadata(
        ...
        """
        metadata = sale.sale_metadata or {}
        additional_data = additional_data or {}
        
        if business_type == BusinessType.HORECA or business_type == BusinessType.CAFE:
            metadata.update({
        ...
        elif business_type == BusinessType.WHOLESALE:
            if sale.customer_id:
        ...
        elif business_type == BusinessType.KITCHEN:
            metadata.update({
    ...
    def process_sale_item_metadata(
        ...
        elif business_type == BusinessType.HORECA or business_type == BusinessType.CAFE:
            # Store modifiers
            metadata.update({
    ...
    def should_print_kitchen_ticket(
        ...
        """
        if business_type in [BusinessType.HORECA, BusinessType.CAFE, BusinessType.KITCHEN]:
            tenant_config = tenant_config or {}
    ...
    def should_auto_deduct_recipe(
        ...
        """
        if business_type == BusinessType.KITCHEN:
